      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Marketing Department Users</h1>
          </div>
          <p className="text-gray-600">Manage marketing team members and their performance</p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-900">Marketing User Details</h2>
                <button
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-gray-900">{selectedUser.campaignLeads}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-500">Social Media Leads</label>
                      <p className="text-gray-900">{selectedUser.socialMediaLeads}</p>
                    </div>
                    <div>
...
export default MarketingDepartmentUser;
